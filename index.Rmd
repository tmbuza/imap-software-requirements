...
<img src="images/variables_freq.svg">


## Read ascending size
```{r}
read_csv("data/metadata/read_size_asce.csv", show_col_types = FALSE) %>%
head()
```
...
```{r}
read_csv("data/metadata/read_size_desc.csv", show_col_types = FALSE) %>%
head()
```
