...
subtitle: |
  ...
  | IMAP: Integrated Microbiome Analysis Pipelines<br><small>Fostering Reproducible Microbioma data Analysis<br><br>
date:
...
## Install conda and Mambaforge
Get helpful information see [`Getting started with conda`](https://docs.conda.io/projects/conda/en/latest/user-guide/getting-started.html).


### Example installing on MAC OS

- Installation: https://docs.conda.io/projects/conda/en/latest/user-guide/install/macos.html
- Miniconda: https://conda.io/miniconda.html
- Anaconda: https://www.anaconda.com/download/

Miniconda3: On CLI run:
```bash
...
- Let's create an environment named `snakemake` and use `python version 10`
