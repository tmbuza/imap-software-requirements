---
title:  "<big><u>IMAP-PART 01</u></big><br><br>Preparing software to get started with systematic microbiome data analysis with Snakemake workflows"
subtitle: |
  | <img src="images/cicd.png"><br>
  | Fostering Reproducible Microbiome data Analysis with Snakemake workflows
date:
...
```{r child='workflow/scripts/03_datascience_tools.Rmd'}
```

<br>

```{r child='workflow/scripts/04_bioinformatics_tools.Rmd'}
```

<br>

```{r child='workflow/scripts/05_ bash_cli_shell_prgm.Rmd', eval=FALSE}
```

<br>

```{r child='workflow/scripts/06_machine_learniing_tools.Rmd', eval=FALSE}
```
