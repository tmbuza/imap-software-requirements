---
title:  |
  | IMAP<br>Integrated Microbiome Analysis Pipelines<br>
  | ![](../images/cicd.png)
  | <u>IMAP-PART 1</u>
date: |
  |  <br>Updated on `r Sys.Date()` <br>
subtitle: |
  | How to get started with Microbiome Data Analysis<br>
...
GitHub Repo: https://github.com/tmbuza/imap-requirements
