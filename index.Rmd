...
# Environment & package management systen
## Install conda
...
- First, we need to confirm if conda or mamba is installed. 
...
- First create the YAML or YML file:
  - `environment.yml`
  - `environment.yaml`
  - SaHere we save the environment.yaml file in `workflow/envs` folder and is configured to contain the following:
```
name: imap
channels:
  - conda-forge
...
The most powerful tools for analyzing and visualikzing microbiome data include:
