...
<br><div id="inprogress" width=100><h3> ...Work In Progress!... </h3> </div><br><br>
...
<ol>
  <li>How to download SRA metadata</li>
    <ul>
      <li>esearch -db sra -query 'PRJNA491191[bioproject]' |  efetch -format runinfo >data/metadata/esearch.csv.</li>
      <li>esearch -db sra -query 'PRJNA491191[bioproject]' |  efetch -format runinfo >data/metadata/esearch.csv</li>
      <li>esearch -db sra -query 'PRJNA477349[bioproject]' | esummary | xtract -pattern DocumentSummary -element Run >data/metadata/esearch.txt</li>
    </ul>
<ol>
